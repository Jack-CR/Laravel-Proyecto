                    ...
                    <tbody>
                        ...
                        @foreach ($products as $product)
                            ...
                            <tr>
                                ...
                                <td><img class="img-responsive" width="200" height="200"
                                        src="http://127.0.0.1:8000/storage/img/posts/{{ $product->imagen }}" alt=""></td>
                                ...
                                <td><a href="{{ route('dashboard.edit', $product->id) }}"><i
                                            class="bi bi-clipboard btn btn-primary"></i></a></td>
                            </tr>
